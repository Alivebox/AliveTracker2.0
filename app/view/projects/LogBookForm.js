Ext.define('AliveTracker.view.projects.LogBookForm', {
    ...
    requires:[
        ...
        'AliveTracker.view.ux.DatePickerField'
    ],
    models:[
        'Group',
        'Project'
    ...
    onDateSelectedAction:function () {
        this.fireEvent('datePickerChanged');
    },
    /**
     * Dispatch the event of saving al info
     */
    onSaveLogHistory:function () {
        this.fireEvent('saveLogHistory');
    }
